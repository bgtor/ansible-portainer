...
This repository contains the `bgtor.portainer` Ansible Collection.
...
[available version](https://galaxy.ansible.com/bgtor/portainer):

```bash
ansible-galaxy collection install bgtor.portainer:==X.Y.Z
```
